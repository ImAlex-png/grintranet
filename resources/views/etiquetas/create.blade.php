...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-xl mx-auto">
        <div class="mb-6 flex items-center space-x-2">
            ...
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Nueva Etiqueta</h1>
        </div>
            ...
            <form action="{{ route('etiquetas.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required placeholder="Ej: Importante"
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" placeholder="Explica para qué sirve esta etiqueta..."
                            class="w-full rounded-xl border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition p-3">{{ old('descripcion') }}</textarea>
